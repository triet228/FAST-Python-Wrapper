...
Aircraft.Specs.TLAR.MaxPax = (UnitConversionPkg.ConvMass(29762.4 + 7200,'lbm','kg') + 3394 + 634)/95;
...
Aircraft.Specs.Propulsion.MDotCF = 1.2;
...
Aircraft.Specs.Aero.L_D.Crs = 17;

% assume same lift-drag ratio during climb and descent
Aircraft.Specs.Aero.L_D.Des = Aircraft.Specs.Aero.L_D.Clb;

% wing loading (kg / m^2)
Aircraft.Specs.Aero.W_S.SLS = UnitConversionPkg.ConvMass(199645, "lbm", "kg") / ...
                              (1317.50 *UnitConversionPkg.ConvLength(1, "ft", "m") ^ 2);
...
Aircraft.Specs.Weight.MTOW = UnitConversionPkg.ConvMass(190000, "lbm", "kg");
...
% get the engine
Aircraft.Specs.Propulsion.Engine = EngineModelPkg.EngineSpecsPkg.CeRAS;
